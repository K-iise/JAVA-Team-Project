...
<%@ page import="cbbs.cBbsDAO" %>
<%@ page import="cbbs.cBbs" %>
...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-Zenh87qX5JnK2Jl0vWa8Ck2rdkQ2Bzep5IDxbcnCeuOxjzrPF/et3URy9Bv1WTRi" crossorigin="anonymous">
  ...
  <body>
	<%
		...
		cBbs cbbs = new cBbsDAO().getcbbs(bbsID);
	%>
				...
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					...
					<tbody>
						<tr>
							...
							<td colspan="2"><%= cbbs.getCbbsTitle().replaceAll(" ", "&nbsp;")
									.replaceAll("<", "&lt;").replaceAll(">","&gt;").replaceAll("\n","<br>") %></td>
						</tr>
						<tr>
							<td>작성자</td>
							<td colspan="2"><%= cbbs.getUserID() %></td>
						</tr>
						<tr>
							<td>작성일자</td>
							<td colspan="2"><%= cbbs.getCbbsDate().substring(0,11) + cbbs.getCbbsDate().substring(11,13) + "시" + cbbs.getCbbsDate().substring(14,16) + "분 "%></td>
						</tr>
						<tr>
							<td>내용</td>
							<td colspan="2" style="height: 200px; text-align: Left"><%= cbbs.getCbbsContent().replaceAll(" ", "&nbsp;")
							.replaceAll("<", "&lt;").replaceAll(">","&gt;").replaceAll("\n","<br>")%></td>
						</tr>
					</tbody>
				</table>
					...
					<!-- 목록 버튼 생성 -->
				<a href="cbbs.jsp" class="btn btn-dark pull-right">목록</a>
				
				<!-- 해당 글의 작성자가 본인이라면 수정과 삭제가 가능하도록 코드 추가 -->
				<%
					if(userID != null && userID.equals(cbbs.getUserID())){
				%>
